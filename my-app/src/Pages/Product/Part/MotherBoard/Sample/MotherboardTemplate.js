...
class MotherboardTemplate extends Component {
    render () {
        return (
            <div className="product-detail white-back">
                ...
                <div className="banner text-center">
                    ...
                    <p className="banner-name">Asus ROG STRIX B450-F GAMING</p>
                </div>
                            ...
                            <div className="block detail-text">
                                ...
                                <ul>
                                    <div className="detail-block border-bottom" id="serieName">
                                        ...
                                        <p className="body">Rog Strix</p>
                                    </div>
                                </ul>
                                <ul>
                                    <div className="detail-block border-bottom" id="serieName">
                                        <p className="title">Memory Slots</p>
                                ...
                                <ul>
                                    <div className="detail-block border-bottom" id="serieName">
                                        ...
                                        <p className="body">bum chat bum</p>
                                    </div>
                                </ul>
                            </div>
                        </div>
