      ...
      <Container className="build-guide">
        ...
        <Row style={{ marginBottom: '50px' }}>
          ...
          <Col md="4" className="build-category-column">
            <CategoryCard
              isCategoryCard={true}
              linkTo="/builds?type=workstation"
